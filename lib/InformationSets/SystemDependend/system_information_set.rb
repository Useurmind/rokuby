module RakeBuilder
  ...
  # They are different from common information sets by the fact that they strongly depend on the
  # system setup and need to be filled with system specific information.
  ...
  class SystemInformationSet < InformationSet
